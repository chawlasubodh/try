...
class AirlinesControllerTest < ActionController::TestCase
  ...
  test "should create airline" do
    assert_difference('Airline.count') do
      post :create, airline: { iata_code: @airline.iata_code, mileage_program: @airline.mileage_program, name: @airline.name }
    end
  ...
  test "should update airline" do
    patch :update, id: @airline, airline: { iata_code: @airline.iata_code, mileage_program: @airline.mileage_program, name: @airline.name }
    assert_redirected_to airline_path(assigns(:airline))
  end
